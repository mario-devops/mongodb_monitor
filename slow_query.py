...
from mongo_server import mongodbMonitor


falcon_client = "http://10.125.242.193:1988/v1/push"
ts = int(time.time())
...
for mongodb_ins in mongodb_items:
        ...
        mongodb_hostname = mongodb_ins["endpoint"]
